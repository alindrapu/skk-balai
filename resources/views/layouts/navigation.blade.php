                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200"
                            src="https://lspgatensi.id/images/logo-white.webp" />
                    </a>
                </div>
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('list-permohonan')" :active="request()->routeIs('list-permohonan')">
                        {{ __('List Permohonan') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('verifikasiData')" :active="request()->routeIs('verifikasiData')">
                        {{ __('Verifikasi') }}
                    </x-nav-link>
